public struct KuyAtt1Suite: ScenarioSuite {
    public init() {}

    public func scenarios() throws -> [ScenarioDefinition] {
        ...
        let definitions: [ScenarioDefinition] = try buildDefinitions(
            seeds: seeds,
            timeStep: timeStep,
            duration: duration,
            envelope: envelope
    ...
    private func buildDefinitions(
        ...
        var results: [ScenarioDefinition] = []
