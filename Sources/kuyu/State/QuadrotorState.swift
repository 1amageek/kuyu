...
public struct QuadrotorState: Sendable, Equatable {
    ...
    public func normalized() -> QuadrotorState {
        QuadrotorState(
    ...
    public func applying(derivative: QuadrotorStateDerivative, scale: Double) -> QuadrotorState {
